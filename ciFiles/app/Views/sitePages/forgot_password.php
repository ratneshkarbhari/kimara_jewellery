                    ...
                    <script>
                        ...
                        $("button#getVerifCode").click(function (e) { 
                            ...
                            if (enteredEmail=='') {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "<?php echo site_url('get-email-verif-code-pw-reset'); ?>",
                                    data: {
                                        'emailEntered' : enteredEmail
                                    },
                                    success: function (response) {
                                        if(response=='customer-doesnt-exist'){
                                            $("p#registration-error").html('Customer Doesnt Exists');
                                        }else if(response=='email-send-fail'){
                                            $("p#registration-error").html('Email sending Failed');
                                        }else if(response=='email-send-success'){
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        if(response=='code-incorrect'){
                                            ...
                                            localStorage.setItem('customerEmail', response);
                                            $("p#registration-error").html('');
                ...
                <div class="container-fluid" id="accountCreateBox" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           ...
                           <button type="button" id="resetPasswordButton" class="btn btn-success">RESET PASSWORD</button>
                        ...
                        <script>
                            ...
                            $("button#resetPasswordButton").click(function (e) { 
                                e.preventDefault();
                                ...
                                if (password1!=password2) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "<?php echo site_url('reset-customer-password'); ?>",
                                        data: {
                                        ...
                                        success: function (response) {
                                            if (response=='password-reset-success') {
                                                window.location="<?php echo site_url('customer-login'); ?>";
                                            }else if (response=='password-reset-fail'){
                                                $("p#registration-error").html('Password reset failed');
                                            }
                                        }
                                    });
                                }
                    ...
                    <div class="text-center" style="margin-top: 15%;">
                        ...
                        <p>Remembered your Password? <a style="color: red;" href="<?php echo site_url('customer-login'); ?>">Login Here</a></p>
