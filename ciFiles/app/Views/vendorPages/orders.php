                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <td class="d-none" style="font-size: 1.2rem; font-weight: 500;">Actions</td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none">
                                <a class="btn btn-primary d-none" data-toggle="modal" data-target="#orderDetailsModal-<?php echo $order['public_order_id']; ?>">See Details</a>
