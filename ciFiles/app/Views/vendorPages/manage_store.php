    ...
    <div class="container">
        ...
        <form action="<?php echo site_url("update-store"); ?>" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
                ...
                <input required class="form-control" value="<?php echo $existing_store['name']; ?>" type="text" name="name" id="name">
            ...
            <img src="<?php echo site_url("assets/store_logos/".$existing_store['logo']); ?>" width="50%" height="50%">
