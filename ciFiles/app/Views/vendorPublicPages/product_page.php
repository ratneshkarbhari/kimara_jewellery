        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12" id='product-details'>
                    ...
                    <p><?php if($product['sku']!=''):  echo 'SKU : '.$product['sku']; endif; ?></p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row" style='margin-top: 5%;'>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 text-left custom-half-grid" style="padding-left: 0; margin-top: 1%;">
                                <a style="font-size: 19px;" href="https://api.whatsapp.com/send?phone=+91<?php echo $vendorData["mobile_number"]; ?>&text=<?php echo urlencode('I am interested in '.site_url('product/'.$product['slug'])); ?>">Inquiry on <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1200px-WhatsApp.svg.png" width="20px" height="20px"></a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-theme" id="related-products">
                <?php foreach($related_products as $related_product): if($related_product['id']!=$product['id']): ?>
                    <a href="<?php echo site_url('product/'.$related_product['slug'].'?store_code='.$store_data["code"]); ?>"><div class="card text-center"> <img src="<?php echo site_url('assets/images/featured_image_product/'.$related_product['featured_image']); ?>" class="card-img-top lazy"><div class="card-body">                            
